...
QUnit.diff = ( function() {
	...
	DiffMatchPatch.prototype.diffCompute = function( text1, text2, checklines, deadline ) {
		...
		if ( i !== -1 ) {
			// Shorter test is inside the longer test (speedup).
			diffs = [
	...
	/**
	 * Rehydrate the test in a diff from a string of line hashes to real lines of
	 * test.
	 * @param {!Array.<!DiffMatchPatch.Diff>} diffs Array of diff tuples.
...
/**
* Escape test for attribute or test content.
*/
